...
def run_linear(
    ...
    return layers.linear(in_features, weights)
...
def run_embedding(
    ...
    return layers.embedding(token_ids, weights)
...
def run_swiglu(
    ...
    return layers.swiglu(in_features, w1_weight, w2_weight, w3_weight)
...
def run_rmsnorm(
    ...
    """
    return layers.rmsnorm(in_features, weights, eps)
